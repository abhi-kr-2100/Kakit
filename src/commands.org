...
(defun kakit--replace-with-char ()
  "Replace selection or char at point with the last key pressed.
If a region is active, replace the entire region with the character
